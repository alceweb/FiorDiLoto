...
public partial class Riservata_ModificaCorsoImg : System.Web.UI.Page
{
    ...
    protected void UpLoadButton_Click(object sender, EventArgs e)
    {
        ...
        string saveDir = Server.MapPath("~/ImgCorsi/");
        if (FileUpload1.HasFile)
        {
            ...
            UploadStatusLabel2.Text = ".";
        }
        else
        {
            // Avvisa del mancato upload.
            UploadStatusLabel1.Text = " ";
    ...
    protected void UploadButton2_Click(object sender, EventArgs e)
    {
        ...
        if (FileUpload2.HasFile)
        {
            ...
            // Avvisa dell'avvenuto upload.
            UploadStatusLabel3.Text = "Immagine caricata corretamente.";
        }
        else
        {
            // Avvisa del mancato upload.
    ...
    protected void UploadButton3_Click(object sender, EventArgs e)
    {
        ...
        if (FileUpload3.HasFile)
        {
            ...
            // Avvisa dell'avvenuto upload.
            UploadStatusLabel5.Text = "Immagine caricata corretamente.";
        }
        else
        {
            // Avvisa del mancato upload.
            UploadStatusLabel6.Text = "Non hai scelto l'immagine per la galleria.";
        }
    }
